...
def readCSVtoDict(csvFileName):
    ...
    attractiveness metric (looks, height, ethnicity), gender, gender (or sometimes ethnicity)
    And the contents are income in $1000 multiples
    We will read this template file and return a dictionary of dictionaries
    First layer of dictionary indicates which column of gender (or ethnicity). Second layer of dictionary
    ...
    dictDict = dict()  # return dict of dictionaries (male/female, or different ethnicities as first layer keys)
